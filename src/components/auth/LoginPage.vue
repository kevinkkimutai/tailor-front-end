...
<div class="p-1 sm:ml-52 bg-white">
  <div class="p-1 border-gray-200 border-dashed rounded-sm dark:border-gray-700 mt-1">
    <section class=" flex items-stretch text-white p-10 rounded-lg">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center logimage" style="background-image: url(../../assets/logo1.png)">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            <div class="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style="background-image: url(../../assets/logo1.png);">
                <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
