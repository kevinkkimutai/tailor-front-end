<template lang="">
<!-- component -->
<div class="p-1 sm:ml-52 bg-white">
  <div class="p-1 border-gray-200 border-dashed rounded-sm dark:border-gray-700 mt-1">
    <section class=" flex items-stretch text-white p-9 rounded-lg">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center logimage" stye="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);">
