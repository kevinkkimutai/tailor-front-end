  ...
  <div class="container relative mx-auto">
    <div class="items-center flex flex-wrap">
      <div class="w-full lg:w-6/12 px-4 ml-auto m-auto text-center">
        <div class="pr-2">
          <h1 class="text-white font-semibold text-5xl pb-5 apparel">
            Apparel Tech's.
          </h1>
          <p class="text-white font-semibold text-xl pb-2">Create an account.</p>
           <!-- alert -->
           <error class="p-b" v-if="error" :error="error"/>
  <!-- end -->
  <form @submit.prevent="handleRegister" class="sm:w-2/3 w-full px-14 lg:px-0 mx-auto">
                    <!-- Username input -->
                    <label for="input-group-1" class="block text-start mb-1 text-sm font-medium text-gray-100 dark:text-white">Username</label>
                    <div class="relative mb-1">
                        ...
                        <input type="text" id="input-group-1" v-model="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Username" required>
                    </div>
                    <!-- Email input -->
                    <label for="input-group-2" class="block text-start mb-1 text-sm font-medium text-gray-100 dark:text-white">Email</label>
                    <div class="relative mb-1">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                        ...
                        <input type="email" id="input-group-2" v-model="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Email" required>
                    </div>
                    <!-- Password input -->
                    <label for="input-group-3" class="block text-start mb-1 text-sm font-medium text-gray-100 dark:text-white">Password</label>
                    <div class="relative mb-1">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
