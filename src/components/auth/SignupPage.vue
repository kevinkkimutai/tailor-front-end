            ...
            <div class="w-full z-20">
                ...
                <form @submit.prevent="handleRegister" class="sm:w-2/3 w-full px-14 lg:px-0 mx-auto">
                    ...
                    <div class="relative mb-2">
                        ...
                        <input type="text" id="input-group-1" v-model="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Username" required>
                    </div>
                    <!-- Email input -->
                    <label for="input-group-2" class="block text-start mb-2 text-sm font-medium text-gray-800 dark:text-white">Email</label>
                    <div class="relative mb-2">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                        ...
                        <input type="email" id="input-group-2" v-model="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Email" required>
                    </div>
                    <!-- Password input -->
                    <label for="input-group-3" class="block text-start mb-2 text-sm font-medium text-gray-800 dark:text-white">Password</label>
                    <div class="relative mb-0">
                        ...
                        <input type="password" id="input-group-3" v-model="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter password" required>
                    </div>
