            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-black text-xl font-semibold">Awarded Agency</h6>
...
<script>
import FooterComponent from "./FooterPage.vue";
export default {
  name: "HomePage",
  components: {
